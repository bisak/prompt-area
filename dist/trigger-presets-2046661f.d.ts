import { S as Segment, a as TriggerPosition, e as TriggerConfig, A as ActiveTrigger, T as TextSegment, C as ChipSegment } from './types-9887bf5c.js';
 ...
 *
 * Defaults: `position: 'start'`, `mode: 'callback'`, `silent: true` (the typed
 * trigger text is stripped and no dropdown shows). Pass `silent: false` to
 * leave the typed trigger char in the editor for the handler to manage.
 */
